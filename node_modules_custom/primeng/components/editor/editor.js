...
var Editor = (function () {
    ...
    Editor.prototype.highlightText = function (delta) {
        var text = this.quill.getText(), hashRegex1 = /(#[a-z\d][\w-]*\s)/ig, match;
        ...
        while (match = hashRegex1.exec(text.slice(0, -1))) {
            isExists = true;
            ...
            //    'bold': true
            //});
            this.quill.formatText(match.index + 1, match.index + match[0].length, 'cssClass', 'test');
